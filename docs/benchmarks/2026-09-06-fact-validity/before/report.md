...
| mrr | 0.8571 | not measured | 0.8571 |
| answer_accuracy | 0.375 | not measured | 0.375 |
| judge_accuracy | not measured | not measured | not measured |
| unanswerable_accuracy | 0 | not measured | 0 |
| stale_answer_rate | 0.125 | not measured | 0.125 |
| context_chars_mean | 79.12 | not measured | 79.12 |
| latency_ms_p50 | 13.62 | not measured | 13.62 |
| latency_ms_p95 | 22.03 | not measured | 22.03 |
